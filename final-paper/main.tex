...
\begin{document}
    ...
    One of the largest constraints in developing the dialogue model was in the amount of GPU compute and Video Random Access Memory (VRAM) available, as all model training was done on a single NVIDIA RTX 3060ti with 8 gigabytes of VRAM .
