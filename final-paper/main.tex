...
\begin{document}
    ...
    The addition of this noise acts as a form of regularization, similar to how noise might be added to training images in image recognition tasks.
    ...
    However, the multiple steps of training the reward model made it very time-consuming to make updates to the model, and the process was sensitive to the quality of the reward model.
